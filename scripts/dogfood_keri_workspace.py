#!/usr/bin/env python3
"""
Dogfood governed-stack across all KERI workspace projects.

This script:
1. Defines governed stacks for each KERI project
...
from governed_stack import StackManager, StackProfile
from governed_stack.handlers import get_handler, HANDLERS
...
def define_governed_stacks(manager: StackManager, owner_baid: str) -> Dict[str, StackProfile]:
    """Define governed stacks for all KERI projects."""
    stacks = {}
...
def run_dogfood() -> WorkspaceReport:
    ...
    # Define all stacks
    print("Defining governed stacks...")
    stacks = define_governed_stacks(manager, owner_baid)
    ...
    print("Generated pyproject.toml snippets saved to: governed-stacks/")
    output_dir = KERI_WORKSPACE / "governed-stack" / "governed-stacks"
...
# Generated by governed-stack dogfood
